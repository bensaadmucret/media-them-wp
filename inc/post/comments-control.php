...
function lejournaldesactus_comment_metabox_callback($post) {
    ...
    <p>
        ...
        <label for="lejournaldesactus_disable_comments"><?php _e(' ' . __('Désactiver les commentaires sur ce contenu', 'lejournaldesactus')); ?></label>
    </p>
    <p class="description">
...
// Toute la logique honeypot/anti-flood est désormais centralisée dans inc/security/honeypot.php
