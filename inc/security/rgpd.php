...
class LeJournalDesActus_RGPD {
    ...
    public static function init() {
        ...
        // Les options RGPD sont désormais gérées via Kirki (kirki-config.php)
    ...
    public static function cookie_banner() {
        ...
        <div id="cookie-banner" class="cookie-banner">
            <div class="cookie-content">
                ...
                <div class="cookie-actions">
                    ...
                    <button id="refuse-cookies" class="refuse-cookies"><?php echo esc_html__('Tout refuser', 'lejournaldesactus'); ?></button>
                    <button id="customize-cookies" class="customize-cookies"><?php echo esc_html__('Personnaliser', 'lejournaldesactus'); ?></button>
                    <?php if ($privacy_page) : ?>
        ...
        <!-- Popin personnalisation cookies -->
        <div id="cookie-preferences-modal" class="cookie-preferences-modal" style="display:none;">
            <div class="cookie-modal-content">
                <h3><?php esc_html_e('Préférences cookies', 'lejournaldesactus'); ?></h3>
                <form id="cookie-preferences-form">
                    <div class="cookie-pref-group">
                        <input type="checkbox" id="cookie-necessary" checked disabled>
                        <label for="cookie-necessary"><strong><?php esc_html_e('Cookies nécessaires', 'lejournaldesactus'); ?></strong> — <?php esc_html_e('Toujours actifs. Indispensables au fonctionnement du site.', 'lejournaldesactus'); ?></label>
                    </div>
                    <div class="cookie-pref-group">
                        <input type="checkbox" id="cookie-analytics">
                        <label for="cookie-analytics"><strong><?php esc_html_e('Cookies statistiques', 'lejournaldesactus'); ?></strong> — <?php esc_html_e('Aident à comprendre l’utilisation du site.', 'lejournaldesactus'); ?></label>
                    </div>
                    <div class="cookie-pref-group">
                        <input type="checkbox" id="cookie-social">
                        <label for="cookie-social"><strong><?php esc_html_e('Cookies réseaux sociaux', 'lejournaldesactus'); ?></strong> — <?php esc_html_e('Permettent le partage et l’intégration de contenus sociaux.', 'lejournaldesactus'); ?></label>
                    </div>
                    <div class="cookie-modal-actions">
                        <button type="button" id="save-cookie-preferences" class="accept-cookies"><?php esc_html_e('Enregistrer mes choix', 'lejournaldesactus'); ?></button>
                        <button type="button" id="close-cookie-preferences" class="refuse-cookies">&times; <?php esc_html_e('Fermer', 'lejournaldesactus'); ?></button>
                    </div>
                </form>
            </div>
        </div>
